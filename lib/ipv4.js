...
var IpV4 = (function () {
    ...
    IpV4.fromString = function (str) {
        var ip = IpV4.tryFromString(str);
        if (!ip) {
            throw new util_1.IPV4Error();
        }
        return ip;
    };
    IpV4.tryFromString = function (str) {
    ...
    IpV4.fromInt = function (int) {
        var ip = IpV4.tryFromInt(int);
        if (!ip) {
            throw new util_1.IPV4Error();
        }
        return ip;
    };
    IpV4.tryFromInt = function (int) {
    ...
    IpV4.fromIntBe = function (int) {
        var ip = IpV4.tryFromIntBe(int);
        if (!ip) {
            throw new util_1.IPV4Error();
        }
        return ip;
    };
    IpV4.tryFromIntBe = function (int) {
        if (int < -0x80000000 || 0xFFFFFFFF < int) {
            return null;
        }
        int = int >>> 0;
    ...
    IpV4.fromIntLe = function (int) {
        var ip = IpV4.tryFromIntLe(int);
        if (!ip) {
            throw new util_1.IPV4Error();
        }
        return ip;
    };
    IpV4.tryFromIntLe = function (int) {
        if (int < -0x80000000 || 0xFFFFFFFF < int) {
            return null;
        }
        int = int >>> 0;
    ...
    IpV4.fromBytes = function (b1, b2, b3, b4) {
        var ip = IpV4.tryFromBytes(b1, b2, b3, b4);
        if (!ip) {
            throw new util_1.IPV4Error();
        }
        return ip;
    };
    IpV4.tryFromBytes = function (b1, b2, b3, b4) {
        if ((b1 < 0 || 255 < b1) ||
            (b2 < 0 || 255 < b2) ||
            (b3 < 0 || 255 < b3) ||
            (b4 < 0 || 255 < b4)) {
    ...
    IpV4.tryFromArray = function (array) {
